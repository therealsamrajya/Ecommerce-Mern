...
const Sidebar = () => {
  return (
    <div className="flex flex-col pt-[30px] gap-[20px] lg:w-[100%] max-w-[250px] h-[100vh] bg-[#E0E0E0] max-sm:flex-row max-sm:w-[100%] max-sm:justify-center max-sm:max-w-none max-sm:h-[20vh] ">
